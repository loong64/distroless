...
def _node_impl(module_ctx):
    ...
    node_archive(
        ...
        sha256 = "5e9ee8c0172f749aaa24d2efe85a59108e3da3da499b73ddea6b86c32b0780f4",
        strip_prefix = "node-v26.9.0-linux-loong64/",
        urls = ["https://github.com/loong64/node/releases/download/v26.9.0/node-v26.9.0-linux-loong64.tar.gz"],
        version = "26.9.0",
        architecture = "loong64",
        control = "//nodejs:control",
    )
