...
def _node_impl(module_ctx):
    ...
    node_archive(
        ...
        sha256 = "b21f357b83ea0fa485ba11237a158803948f93fcda871a3a7420b45054bba9d4",
        strip_prefix = "node-v26.8.2-linux-loong64/",
        urls = ["https://github.com/loong64/node/releases/download/v26.8.2/node-v26.8.2-linux-loong64.tar.gz"],
        version = "26.8.2",
        architecture = "loong64",
        control = "//nodejs:control",
    )
